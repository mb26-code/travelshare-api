...
# Configuration
API_URL="http://localhost:3000/media/frames"
TOKEN="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiZW1haWwiOiJtZWhkaUBleGFtcGxlLmNvbSIsImlhdCI6MTc2Nzc5ODM1MiwiZXhwIjoxNzY3ODg0NzUyfQ.wQVqIz-aFXcWHrLTPgm0TEV5GAdn-w6C4bYuYQhy73M"
